...
check_pdus \
	...
	"ipv6-prefix    version 0 zero1 0 length 32 flags 1 plen 16 maxlen 16 zero2 0 prefix 103:: as 10001" \
	"ipv6-prefix    version 0 zero1 0 length 32 flags 1 plen 16 maxlen 16 zero2 0 prefix 102:: as 10001" \
	"ipv6-prefix    version 0 zero1 0 length 32 flags 1 plen 16 maxlen 16 zero2 0 prefix 101:: as 10001" \
...
check_pdus \
	"cache-response version 0 session [0-9]+ length 8" \
	"ipv6-prefix    version 0 zero1 0 length 32 flags 0 plen 16 maxlen 16 zero2 0 prefix 102:: as 10001" \
	"end-of-data    version 0 session [0-9]+ length 12 serial 2"
