...
# Simulating that the router sends error code 11 [Ordering Error] to the server.
send_router_pdu "error-report   version 2 error-code 11 length 16 encapsulated-pdu-length 0 error-text-length 0"

check_logfile fort1 -F "ERR: RTR client 127.0.0.1 responded with error PDU 'Ordering Error'. Closing socket."
